...
namespace LINQMethodSyntax
{
    internal class Employees
    {
        ...
        public List<int> Appraisal { get { return appraisal; } set { appraisal = value; } }
        ...
        public static void DisplayWithApparisal(List<Employees> employees, string message)
        {
            ...
            foreach (var employee in employees)
            {
                Console.Write($"{employee.FirstName} {employee.LastName} {employee.Salary} {employee.Age}, last 3 apprisals |");
